...
def git_update(repo, is_no_errors=False, is_current_dir=False, git_owner=""):
  ...
  url = "https://github.com/cherfia/server.git" if repo == "server" else "https://github.com/" + owner + "/" + repo + ".git"
  if config.option("git-protocol") == "ssh":
    url = "git@github.com:cherfia/server.git" if repo == "server" else "git@github.com:ONLYOFFICE/" + repo + ".git"
